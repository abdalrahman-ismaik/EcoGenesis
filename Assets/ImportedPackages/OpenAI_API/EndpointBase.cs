...
namespace OpenAI_API
{
    ...
    public abstract class EndpointBase
    {
        ...
        protected HttpClient GetClient()
        {
            ...
            // Always create a new HttpClient (Unity compatible)
            ...
            else
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        if (parsedError.Error.ErrorCode == "insufficient_quota")
                        {
                            // Add a special marker for quota errors
                            errorToThrow.Data.Add("user_friendly_message", "You have exceeded your OpenAI API quota. Please check your plan and billing details at https://platform.openai.com/account/usage.");
                        }
                    }
