...
namespace StarterAssets
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        {
            // Check if the inventory system exists and is open
            ...
            {
                return; // Skip the camera rotation update if pause menu is open
            }

            // Check if required components exist
            if (_input == null || CinemachineCameraTarget == null)
            {
                Debug.LogWarning("Required components missing for camera rotation");
                return;
            }
